...
function start() {
    ...
    $("body").on("click", ".box", function () {
        ...
        let CHANGEcounter = $(".red").length - 1;
        REDcounter.val(CHANGEcounter);
        CHANGEcounter = $(".blue").length - 1;
        BLUEcounter.val(CHANGEcounter);
        CHANGEcounter = $(".yellow").length - 1;
        YELLOWcounter.val(CHANGEcounter);
        CHANGEcounter = $(".none").length - 1;
        NONEcounter.val(CHANGEcounter);
    });
}
