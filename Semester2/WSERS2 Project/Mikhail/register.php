    ...
    <main class="register">
        ...
        if (isset($_POST["Username"], $_POST["psw"], $_POST["pswAgain"], $_POST["email"], $_POST["age"])) {
            ...
            if ($_POST["psw"] == null || $_POST["Username"] == null || $_POST["email"] == null || $_POST["age"] == null) {
                ...
                $sqlQuery=$connection->prepare("insert into Clients(Username, HashPassword, Email, Age, UserType) values(?, ?, ?, ?, 'customer')");
                $hpas=password_hash($_POST["psw"], PASSWORD_DEFAULT);
                $username=htmlspecialchars($_POST["Username"]);
                $email=htmlspecialchars($_POST["email"]);
                $sqlQuery->bind_param("sssi", $username, $hpas, $email, $_POST["age"]);
                $sqlQuery->execute();
            }
        }
        if ($showForm) {
