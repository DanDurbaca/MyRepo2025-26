...
<body>
    ...
    <div class="login-container">
        ...
        if (isset($_POST["username"], $_POST["password"])) {
            ...
            $sqlFindUser=$connection->prepare("SELECT * FROM Clients WHERE Username = ?");
            ...
            if ($sqlResult->num_rows==0) {
                ...
                $row = $sqlResult -> fetch_assoc();
                    if (password_verify($_POST["password"], $row ["userPassword"])) {
                        ...
                        $_SESSION['userType'] = $row["userTypes"];
                        $found = true;
            ...
            /*while (!feof($fileClients)) {
                ...
                if (count($clientData) >= 2) {
                    if ($clientData[0] == $username && password_verify($password,$clientData[1])) {
                        $found = true;
            ...
            */
            ...
            if (!$found && $showForm && !$errorMessage) {
                $errorMessage = t('login_error');
            }
        }
