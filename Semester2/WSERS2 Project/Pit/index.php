...
<head>
    ...
    <title><?= htmlspecialchars($arrayOfTranslations["HomeBtn"] ?? "Home", ENT_QUOTES, 'UTF-8') ?></title>
...
<body>
    ...
    NavigationBar($arrayOfTranslations["HomeBtn"] ?? "Home");
     ?>

    <header>
        <h1><?= $arrayOfTranslations["HomeTextTitle"]?></h1>
        <h2><?= $arrayOfTranslations["HomeTextH2"] ?></h2>
    </header>
