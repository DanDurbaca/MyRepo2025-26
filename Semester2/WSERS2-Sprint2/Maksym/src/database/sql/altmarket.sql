...
--
-- Host: localhost
-- Generation Time: May 30, 2026 at 11:09 AM
...
CREATE TABLE `orders` (
  ...
  `ord_product_name` varchar(100) NOT NULL,
  `ord_product_description` varchar(255) NOT NULL,
  `ord_product_quantity` int(11) NOT NULL,
  `ord_product_price` float NOT NULL,
  `ord_product_img` varchar(255) NOT NULL,
  `ord_product_status` varchar(12) NOT NULL DEFAULT 'pending',
  `user_id` int(11) NOT NULL,
