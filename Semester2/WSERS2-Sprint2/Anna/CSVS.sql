...
CREATE TABLE BoughtItems (
    ...
    id INT NOT NULL, -- This matches your 'Products' table primary key name (id)
...
('SuccessOrder', 'Order placed successfully! You can track it in your history.', 'Заказ успешно оформлен! Вы можете отслеживать его в своей истории.'),
