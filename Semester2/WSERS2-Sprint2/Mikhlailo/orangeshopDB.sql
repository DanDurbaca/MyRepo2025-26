...
-- Ensure the script works on typical MySQL installations: drop if exists, create with utf8mb4 and use it
DROP DATABASE IF EXISTS OrangeShopDB;
CREATE DATABASE OrangeShopDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE OrangeShopDB;
...
INSERT INTO Translations (translationKey, en, fr, de) VALUES
('make_order', 'Make Order', 'Passer la commande', 'Bestellung aufgeben'),
('update_cart', 'Update cart', 'Mettre à jour le panier', 'Warenkorb aktualisieren');
