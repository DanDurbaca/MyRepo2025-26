...
('Admin13','Delivered Orders','Gelieferte Bestellungen'),
('Admin14','Order ID','Bestellnummer'),
('Admin15','Username','Benutzername'),
('Admin16','Status','Status'),
('Admin17','Action','Aktion'),
('Admin18','Pending Orders','Ausstehende Bestellungen'),
('Admin19','Mark as Delivered','Als zugestellt markieren'),
('Admin20','No delivered orders history found.','Keine Historie gelieferter Bestellungen gefunden.'),
('Admin21','No pending orders found.','Keine ausstehenden Bestellungen gefunden.'),
...
('cart1','Shop cart contents','Inhalt des Warenkorbs'),
('cart2','Item','Artikel'),
('cart3','Quantity','Menge'),
('cart4','Price','Preis'),
('cart5','Total: ','Gesamt: '),
('cart6','There is nothing to do here. Please add things to the cart first.','Es gibt hier nichts zu tun. Bitte fügen Sie zunächst Dinge zum Warenkorb hinzu.'),
('cart7','Your Order History','Ihre Bestellhistorie'),
('cart8','Order ID','Bestellnummer'),
('cart9','Status','Status'),
('cart10','You havent placed any orders yet.','Sie haben noch keine Bestellungen aufgegeben.'),
('cart11','Place order','Bestellung aufgeben'),
('cart12','Delete','Löschen');
