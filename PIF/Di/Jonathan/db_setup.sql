...
--
-- Table structure for table `station_share`
--

CREATE TABLE `station_share` (
    `id` int NOT NULL,
    `station_serial` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
    `owner_user` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
    `shared_with` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Indexes for table `station_share`
--
ALTER TABLE `station_share`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `uk_station_share` (`station_serial`,`shared_with`),
    ADD KEY `idx_station_share_owner` (`owner_user`),
    ADD KEY `idx_station_share_shared_with` (`shared_with`);
...
--
-- AUTO_INCREMENT for table `station_share`
--
ALTER TABLE `station_share`
...
--
-- Constraints for table `station_share`
--
ALTER TABLE `station_share`
    ADD CONSTRAINT `fkc_station_share_station` FOREIGN KEY (`station_serial`) REFERENCES `station` (`pk_serialNumber`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `fkc_station_share_owner` FOREIGN KEY (`owner_user`) REFERENCES `user` (`pk_username`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `fkc_station_share_shared_with` FOREIGN KEY (`shared_with`) REFERENCES `user` (`pk_username`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
