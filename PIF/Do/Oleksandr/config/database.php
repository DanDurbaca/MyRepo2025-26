...
define('DB_NAME', getenv('DB_NAME') ?: 'cheol904_db');

if (!defined('APP_URL')) define('APP_URL', getenv('APP_URL') ?: 'http://localhost');
//$defaultMailHost = (getenv('DB_HOST') ?: 'localhost') === 'localhost' ? 'mailhog' : '127.0.0.1';
$defaultMailHost = '127.0.0.1';
if (!defined('MAIL_HOST')) define('MAIL_HOST', getenv('MAIL_HOST') ?: $defaultMailHost);
