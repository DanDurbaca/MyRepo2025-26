...
<section class="contact-section">
    ...
    <div class="contact-container">
        <div class="contact-info">
            ...
            <p><strong><?= $arrayOfTranslations['Address'][$language] ?? 'Address' ?>:</strong> 123 Citrus Street, Orange City</p>
            <p><strong><?= $arrayOfTranslations['Phone'][$language] ?? 'Phone' ?>:</strong> +1 555 123 456</p>
            <p><strong><?= $arrayOfTranslations['Email'][$language] ?? 'Email' ?>:</strong> info@orangeshop.com</p>
        </div>
